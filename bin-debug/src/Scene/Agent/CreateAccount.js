...
var CreateAccount = (function (_super) {
    ...
    function CreateAccount() {
        ...
        _this.skinName = "resource/skin/Scene/Agent/CreateAccount/CreateAccount.exml";
        ...
        _this.agentCreateBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            if (zUtils.getText(_this.accountInput) == '' || zUtils.getText(_this.passwordInput) == '' || zUtils.getText(_this.fullNameInput) == '') {
            ...
            zHttp.getInstance().sendHttpRequest(_this, "account/create", egret.HttpMethod.POST, function (e) {
