...
var InputTips = (function (_super) {
    __extends(InputTips, _super);
    function InputTips(_chargeTo, chargeInfo) {
        var _this = _super.call(this) || this;
        _this.skinName = 'resource/skin/Misc/InputTips/InputTips.exml';
        ...
        _this.commitBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            ...
            if (!IsNum(chargeNumber)) {
                ...
                zHttp.getInstance().sendHttpRequest(_this, "agent/recharge", egret.HttpMethod.POST, function (e) {
    ...
    InputTips.prototype.partAdded = function (partName, instance) {
        _super.prototype.partAdded.call(this, partName, instance);
    };
    InputTips.prototype.childrenCreated = function () {
        _super.prototype.childrenCreated.call(this);
    };
    return InputTips;
}(eui.Component));
__reflect(InputTips.prototype, "InputTips");
//# sourceMappingURL=InputTips.js.map